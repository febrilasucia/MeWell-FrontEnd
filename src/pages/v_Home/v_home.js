  ...
  return (
    <div>
      <div className="flex-none sm:flex-none md:flex">
        ...
        <div className="">
          <div className="">
            <img className="absolute md:w-[460px]" src={CloudUp} />
          ...
          <div className="block">
            ...
            <img className="md:w-[460px]" src={Chairs} />
          </div>
        </div>
        ...
        <div className="mb-[400px] md:mb-0">
          <div className="mx-[20px] mt-[30px]">
            <img src={StarYellow} className="h-[170px]" />
          </div>
          ...
          <div className="absolute -mt-[100px]">
            <img src={CloudDown} className="md:h-[440px]  h-auto" />
          </div>
      ...
      <div className="flex-none sm:flex-none md:flex ">
        {/* Part 2 Konsultasi Permasalahan */}
        <div className="">
          <img className="absolute  md:w-[460px] h-[700px]" src={CloudUp} />
          <div className="md:w-[460px]">
          ...
          <div className="block">
            ...
            <img className="md:w-[460px] mt-[180px] md:mt-0" src={Child} />
          </div>
        </div>
        {/* Part 2 Konsultasi Permasalahan */}
        {/* Part 1 Konsultasi Permasalahan */}
        <div className="">
          <div className="block">
            <img className="md:w-[460px]" src={Principal} />
          </div>
          <div className="">
            <img className="absolute md:w-[460px]" src={CloudUp} />
        ...
        {/* Part 3 Konsultasi Permasalahan */}
        <div className="">
          <img className="absolute h-[700px]" src={CloudUp} />
          <div className="">
            <div className="absolute md:w-[460px] mx-[60px] text-textOpt mt-[50px]">
              ...
              <p className="md:w-[250px] text-sizeParagraph">
                We organize fun activities to help your child's learning process
