    ...
    <div className="flex">
      ...
      <div className="w-[1000px] mx-auto mt-10 justify-center">
        ...
        <div>
          ...
          <p className="my-3 text-textFunc">Dashboard / Konsultasi / Detail</p>
        </div>
        {/* judul */}
        {/* content */}
              ...
              <div className="w-full ">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    <button
                      type="button"
                      className="w-[100px] px-4 py-2 bg-bgFunc3 text-white rounded-md hover:bg-bgFunc focus:outline-none focus:ring focus:ring-gray-300"
